...
key_path = os.path.join(os.path.dirname(__file__), "secrets/key.json")
...
def authenticate():
    # This is not a scalable way to doing this—it relies on a file I have locally that's not committed to the repo, but
    # these are the instructions (https://github.com/ksm26/Understanding-and-Applying-Text-Embeddings/blob/main/l7_optional.ipynb)
    # I have. If this were a real project, I'd probably use the commented code below, but since it's for a write-once
    # read never learning project, I'm fine doing it this way
